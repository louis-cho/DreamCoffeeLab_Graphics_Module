export default class SimOverlayMenu {
  constructor(div) {
    this.div = div;

    SimOverlayMenu.I = this;
  ...
  init() {
    this.SimOverlayMenuDiv = document.createElement("div");
    this.SimOverlayMenuDiv.id = "SimOverlayMenu";

    this.div.appendChild(this.SimOverlayMenuDiv);
    this.SimOverlayMenuDiv.innerHTML = this.appendHTML();

    // 툴팁 요소를 찾아서 이벤트 핸들러를 추가합니다.
    // const tooltipElements = this.SimOverlayMenuDiv.querySelectorAll('.ui-button')
    ...
    document
      .getElementById("population-icon")
      .addEventListener("click", function () {
        SimOverlayMenu.I.createInfoOverlay();
      });
  }

  createInfoOverlay() {
    if (SimOverlayMenu.I.info) SimOverlayMenu.I.info.remove();
    SimOverlayMenu.I.info = document.createElement("div");
    SimOverlayMenu.I.info.className = "overlay";
    ...
    SimOverlayMenu.I.info.appendChild(containerDiv);

    // overlay를 body에 추가
    document.body.appendChild(SimOverlayMenu.I.info);
  }
  ...
  showTooltip(event) {
    ...
    if (tooltipText) {
      let num =
        window.simulate.game.tileManager.getNumOfFacilityByType(tooltipText);
      if (num != undefined) {
  ...
  appendHTML() {
    ...
    ihtml[idx++] =
      '      <img id="population-icon" src="./simulator/asset/img/info.png">';
    ihtml[idx++] = "    </div>";
    ihtml[idx++] = "  </div>";
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/university.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/cinema.png">';
    ihtml[idx++] = "      </button>";
    ihtml[idx++] =
      '      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/theater.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/hotel.png">';
    ihtml[idx++] = "      </button>";
    ihtml[idx++] =
      '      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/apartment.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/hospital.png">';
    ihtml[idx++] = "      </button>";
    ihtml[idx++] =
      '      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/bank.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/publicservice.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/drugstore.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] =
    ...
    ihtml[idx++] = '      <button id="button-residential4" class="ui-button">';
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/subway.png">';
    ihtml[idx++] = "      </button>";
    ihtml[idx++] =
      '      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/busstop.png">';
    ihtml[idx++] = "        </button>";
    ihtml[idx++] = "      </div>";
    ihtml[idx++] = "    </div>";
    ...
    ihtml[idx++] = '      <button id="button-residential4" class="ui-button">';
    ihtml[idx++] =
      '        <img class="toolbar-icon" src="./simulator/asset/img/clerk.png">';
    ihtml[idx++] = "      </button>";
    ihtml[idx++] =
      '      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">';
    ihtml[idx++] =
    ...
    ihtml[idx++] =
      '      <img id="pause-button-icon" class="toolbar-icon" src="./simulator/asset/img/play-color.png">';
    ihtml[idx++] = "    </button>";
    ihtml[idx++] = "  </div>";
  ...
  async onSelectButton(data) {
    ...
    if (type == "select") {
      ...
      if (window.simulate.game.ui.pause == 0) {
        ...
        if (
          curlog.addfacility.length == 0 &&
          curlog.removefacility.length == 0
        ) {
  ...
  setPause(pause) {
    ...
    switch (pause) {
      case 0:
        {
          document.getElementById("pause-button-icon").src =
            "./simulator/asset/img/play-color.png";
        }
        break;
      ...
      case 1:
        {
          document.getElementById("pause-button-icon").src =
            "./simulator/asset/img/play-fast-foward.png";
        }
        break;
      ...
      case 2:
        {
          document.getElementById("pause-button-icon").src =
            "./simulator/asset/img/play-fast-fast-foward.png";
        }
        break;
      case 3:
        {
          document.getElementById("pause-button-icon").src =
            "./simulator/asset/img/pause-color.png";
        }
        break;
    }
  }
